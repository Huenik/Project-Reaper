...
/*
	Errors:
	001 Preset2 file unable to be created due to no matches found in variable modsetHtmlText. said html text comes from https://github.com/Huenik/Project-Reaper/blob/main/modset.html