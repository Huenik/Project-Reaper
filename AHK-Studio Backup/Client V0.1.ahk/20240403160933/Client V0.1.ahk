...
MsgBox, Latest Version: %latestCommit%
...
MsgBox, 4,Add to Presets?, Would you like to add this to your ARMA3 presets? (press Yes or No)
IfMsgBox Yes
...
if (matches.Length()) {
	...
	MsgBox,,Error001," Unable to create preset2 file, error001"
	goto, updated
}
